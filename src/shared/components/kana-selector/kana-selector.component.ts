...
export class KanaSelectorComponent {
  ...
  button(element: string) {
    switch(element) {
      case 'all': this.game_service.filter.toggle_all(); break;
      case 'enable_hiragana': this.game_service.filter.toggle_kana('HIRAGANA', true); break;
      case 'disable_hiragana': this.game_service.filter.toggle_kana('HIRAGANA', false); break;
      ...
      break;
      case 'enable_katakana': this.game_service.filter.toggle_kana('KATAKANA', true); break;
      case 'disable_katakana': this.game_service.filter.toggle_kana('KATAKANA', false); break;
